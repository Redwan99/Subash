...
export function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 flex md:hidden z-50 h-[var(--bottom-nav-height)] bg-white/40 dark:bg-black/40 backdrop-blur-xl border-t border-gray-200 dark:border-white/5 shadow-[0_-8px_40px_rgba(0,0,0,0.08)] dark:shadow-[0_-8px_40px_rgba(0,0,0,0.20)]"
