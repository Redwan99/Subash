    ...
    return (
        <div className="min-h-screen bg-[var(--bg-base)] text-[var(--text-primary)]">
            ...
            <section className="relative overflow-hidden pt-32 pb-20 px-6 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
                <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-[rgba(232,67,147,0.15)] rounded-full blur-[100px] pointer-events-none" />

                <div className="flex-1 space-y-6 z-10">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#E84393]/30 bg-[#E84393]/10 text-[#F783AC] text-sm font-semibold mb-4">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black tracking-tight text-[var(--text-primary)] leading-tight">
                        Take Control of <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#F783AC] to-[#38BDF8]">Your Brand</span>
                    </h1>
