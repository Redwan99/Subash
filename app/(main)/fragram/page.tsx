  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto animate-fade-in-up">
      <div className="flex items-center justify-between mb-8">
        ...
        <button className="bg-brand-500 hover:bg-brand-400 text-white dark:text-black font-semibold px-6 py-3 rounded-xl shadow-lg shadow-brand-500/20 transition-all active:scale-95">
          + Post Photo
        </button>
      </div>
          ...
          <div key={post.id} className="break-inside-avoid relative group rounded-[2rem] overflow-hidden bg-gray-50 dark:bg-[#0a0a0a] border border-gray-200 dark:border-white/10 gpu-accelerate">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                ...
                <button className="flex items-center gap-1.5 text-white hover:text-brand-400 transition-colors">
